...
import (
	...
	"github.com/hechain20/hechain/integration/pvtdata/marblechaincodeutil"
	...
	When("chaincode has no private data collections", func() {
		...
		It("generates snapshot and bootstraps from snapshots", func() {
			...
			cc2 := nwo.Chaincode{
				Name:            "kvexecutor",
				Version:         "1.0",
				Path:            components.Build("github.com/hechain20/hechain/integration/chaincode/kvexecutor/cmd"),
				Lang:            "binary",
				SignaturePolicy: `OR ('Org1MSP.member','Org2MSP.member', 'Org3MSP.member', 'Org4MSP.member')`,
	...
	When("chaincode has private data collections", func() {
		BeforeEach(func() {
			newlifecycleChaincode = nwo.Chaincode{
				Name:              "marblesp",
				Version:           "1.0",
				Path:              components.Build("github.com/hechain20/hechain/integration/chaincode/marbles_private/cmd"),
				Lang:              "binary",
