...
import (
	...
	"github.com/hechain20/hechain/integration/nwo/commands"
...
var _ = Describe("Release interoperability", func() {
	...
	It("deploys and executes chaincode, upgrades the channel application capabilities to V2_0, and uses _lifecycle to update the endorsement policy", func() {
		...
		chaincode := nwo.Chaincode{
			Name:    "mycc",
			Version: "0.0",
			Path:    "github.com/hechain20/hechain/integration/chaincode/simple/cmd",
		...
		chaincode = nwo.Chaincode{
			Name:            "mycc",
			Version:         "0.0",
			Path:            components.Build("github.com/hechain20/hechain/integration/chaincode/simple/cmd"),
			Lang:            "binary",
		...
		Describe("Chaincode-to-chaincode interoperability", func() {
			...
			BeforeEach(func() {
				...
				callerDefOld = nwo.Chaincode{
					Name:    "caller",
					Version: "0.0",
					Path:    "github.com/hechain20/hechain/integration/lifecycle/chaincode/caller/cmd",
					Ctor:    `{"Args":[""]}`,
					Policy:  ccEP,
				}
				calleeDefOld = nwo.Chaincode{
					Name:    "callee",
					Version: "0.0",
					Path:    "github.com/hechain20/hechain/integration/lifecycle/chaincode/callee/cmd",
					Ctor:    `{"Args":[""]}`,
					Policy:  ccEP,
				}
				callerDefNew = nwo.Chaincode{
					Name:            "caller",
					Version:         "0.0",
					Path:            components.Build("github.com/hechain20/hechain/integration/lifecycle/chaincode/caller/cmd"),
					Lang:            "binary",
				...
				calleeDefNew = nwo.Chaincode{
					Name:            "callee",
					Version:         "0.0",
					Path:            components.Build("github.com/hechain20/hechain/integration/lifecycle/chaincode/callee/cmd"),
					Lang:            "binary",
