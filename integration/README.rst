...
This directory contains implementations of integration and feature testing for Hechain.
...
-------------------------------------
There is a target in the Hechain Makefile for executing integration tests.
...
To add your contributions to the Hechain project, please refer to the
`Hechain Contribution`_ page for more details.

.. _Hechain Contribution: http://hyperledger-fabric.readthedocs.io/en/latest/CONTRIBUTING.html
