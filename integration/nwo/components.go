...
func (c *Components) ConfigTxGen() string {
	return c.Build("github.com/hechain20/hechain/cmd/configtxgen")
}

func (c *Components) Cryptogen() string {
	return c.Build("github.com/hechain20/hechain/cmd/cryptogen")
}

func (c *Components) Discover() string {
	return c.Build("github.com/hechain20/hechain/cmd/discover")
}
...
func (c *Components) Orderer() string {
	return c.Build("github.com/hechain20/hechain/cmd/orderer")
}

func (c *Components) Osnadmin() string {
	return c.Build("github.com/hechain20/hechain/cmd/osnadmin")
}

func (c *Components) Peer() string {
	return c.Build("github.com/hechain20/hechain/cmd/peer")
}
