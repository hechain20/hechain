...
# 'BenchmarkInsertTxs' in package 'github.com/hechain20/hechain/core/ledger/kvledger/benchmark/experiments'
#
# runReadWriteTxs - This function sets the environment variables and runs the benchmark function
# 'BenchmarkReadWriteTxs' in package 'github.com/hechain20/hechain/core/ledger/kvledger/benchmark/experiments'
#
# For the details of test specific parameters, refer to the documentation in 'go' files for the tests
#######################################################################################################

PKG_NAME="github.com/hechain20/hechain/core/ledger/kvledger/benchmark/experiments"
