...
import (
	...
	"github.com/hechain20/hechain/core/chaincode/implicitcollection"
	"github.com/hechain20/hechain/core/ledger"
	"github.com/hechain20/hechain/core/ledger/cceventmgmt"
	"github.com/hechain20/hechain/core/ledger/confighistory/confighistorytest"
	"github.com/hechain20/hechain/core/ledger/internal/version"
	kvledgermock "github.com/hechain20/hechain/core/ledger/kvledger/mock"
	...
	"github.com/hechain20/hechain/core/ledger/mock"
	"github.com/hechain20/hechain/internal/fileutil"
...
func TestGenerateSnapshotErrors(t *testing.T) {
	...
	t.Run("block store returns error", func(t *testing.T) {
		...
		require.Contains(t, errStackTrace, "github.com/hechain20/hechain/common/ledger/blkstorage")
	})
	...
	t.Run("config history mgr returns error", func(t *testing.T) {
		...
		errStackTrace := fmt.Sprintf("%+v", err)
		require.Contains(t, errStackTrace, "internal leveldb error while obtaining db iterator")
		require.Contains(t, errStackTrace, "github.com/hechain20/hechain/core/ledger/confighistory")
	})
