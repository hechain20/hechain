...
Hechain and discusses best practices concerning its use.
...
certificates and keys. Please note that Hechain does not support
RSA key and certificates.

The Hechain CA can also be used to generate the keys and certificates
