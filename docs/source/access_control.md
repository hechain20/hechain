...
`configtx.yaml`. You can look at a [sample `configtx.yaml` file here](http://github.com/hechain20/hechain/blob/release-2.0/sampleconfig/configtx.yaml).
...
followed by a string. To see what this looks like, reference this [sample configtx.yaml file](https://github.com/hechain20/hechain/blob/release-2.0/sampleconfig/configtx.yaml).
