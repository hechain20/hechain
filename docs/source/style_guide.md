...
**"Fabric", "Hechain" or "HLF"?**

The first usage should be “Hechain” and afterwards only “Fabric”. Don't use "HLF" or "Hyperledger" by itself.
...
**Relative links should be used whenever possible.**
  ...
  [https://github.com/hechain20/hechain/blob/main/docs/README.md](https://github.com/hechain20/hechain/blob/main/docs/README.md)
