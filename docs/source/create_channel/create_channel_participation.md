...
- Modify the `orderer.yaml` for each ordering node to support this feature and restart the node. See the orderer [sampleconfig](https://github.com/hechain20/hechain/blob/{BRANCH}/sampleconfig/orderer.yaml) for more information about these required parameters.
