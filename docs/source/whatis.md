...
enterprise use, Hechain has been _designed_ for enterprise use from
the outset. The following sections describe how Hechain (Fabric)
...
Hechain is an open source enterprise-grade permissioned distributed
...
diverse technical steering committee, and the Hechain project by a
...
Hechain has been specifically architected to have a modular
...
rule them all". Hechain can be configured in multiple ways to
...
Hechain, being a permissioned platform, enables confidentiality
...
etc. The Hechain [Performance and Scale working group](https://wiki.hyperledger.org/display/PSWG/Performance+and+Scale+Working+Group)
...
capabilities of Hechain. The latest [scaled Fabric to 20,000 transactions per second](https://arxiv.org/abs/1901.00910).

## Conclusion

Any serious evaluation of blockchain platforms should include Hechain
in its short list.
...
Hechain is the most active of the Hyperledger projects. The community
...
["Hechain: A Distributed Operating System for Permissioned Blockchains"](https://dl.acm.org/doi/10.1145/3190508.3190538) - Elli Androulaki, Artem
