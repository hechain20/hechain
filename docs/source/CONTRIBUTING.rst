...
Ways to contribute
------------------
There are many ways you can contribute to Hechain, both as a user and
as a developer.
...
- If you only have a little time, consider picking up a
  `"good first issue" <https://github.com/hechain20/hechain/labels/good%20first%20issue>`_ task,
...
- If you can commit to full-time development, either propose a new feature
  ...
  `GitHub epic backlog <https://github.com/hechain20/hechain/labels/Epic>`_,
  contact the Epic assignee via the GitHub issue.

Getting a Linux Foundation account
----------------------------------

In order to participate in the development of the Hechain
...
Hechain is managed under an open governance model as described in
...
The Fabric project is lead by the project's top level `maintainers <https://github.com/hechain20/hechain/blob/main/MAINTAINERS.md>`__.
...
`maintainers <https://github.com/hechain20/hechain/blob/main/MAINTAINERS.md>`__ file.
...
`GitHub issues with Epic label <https://github.com/hechain20/hechain/labels/Epic>`__.
...
`GitHub Issues <https://github.com/hechain20/hechain/issues>`__.
...
reviewed. You can also post to the relevant Hechain channel in
...
Fabric issues and bugs are managed in `GitHub issues <https://github.com/hechain20/hechain/issues>`__.
Review the list of issues and find
something that interests you. You could also check the
`"good first issue" <https://github.com/hechain20/hechain/labels/good%20first%20issue>`__
...
Another way to contribute and learn about Hechain is to help the
...
<https://github.com/hechain20/hechain/pulls>`__ to get started.
...
<https://github.com/hechain20/hechain/blob/main/docs/source/dev-setup/headers.txt>`__.

We have tried to make it as easy as possible to make contributions. This
applies to how we handle the legal aspects of contribution. We use the
same approach—the `Developer's Certificate of Origin 1.1
(DCO) <https://github.com/hechain20/hechain/blob/main/docs/source/DCO1.1.txt>`__—that the Linux® Kernel
