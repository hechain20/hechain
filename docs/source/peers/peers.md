...
A fundamental element of a Hechain blockchain network is the set of
*peer nodes* (or, simply, *peers*). Peers are fundamental because they manage
ledgers and smart contracts. Starting in Hechain v2.4, peers also
...
Starting in Hechain v2.4, the [Fabric Gateway](../gateway.html) service
...
that peers are in many ways the most fundamental element of Hechain
