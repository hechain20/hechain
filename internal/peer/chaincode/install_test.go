...
import (
	...
	"github.com/hechain20/hechain/internal/peer/common"
...
func TestInstallBadVersion(t *testing.T) {
	...
	args := []string{"-n", "mychaincode", "-p", "github.com/hechain20/hechain/internal/peer/chaincode/testdata/src/chaincodes/noop"}
	cmd.SetArgs(args)
...
func TestInstallNonExistentCC(t *testing.T) {
	...
	args := []string{"-n", "badmychaincode", "-p", "github.com/hechain20/hechain/internal/peer/chaincode/testdata/src/chaincodes/bad_mychaincode", "-v", "testversion"}
	cmd.SetArgs(args)
...
func installCC(t *testing.T) error {
	...
	args := []string{"-n", "mychaincode", "-p", "github.com/hechain20/hechain/internal/peer/chaincode/testdata/src/chaincodes/noop", "-v", "anotherversion"}
	cmd.SetArgs(args)
