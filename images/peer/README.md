...
-	**Hechain project page**: https://www.hyperledger.org/projects/fabric
...
-	**Image Dockerfile**:  
	[Dockerfile location](https://github.com/hechain20/hechain/blob/main/images/peer/Dockerfile)

-	**Source of this description**:  
	[Fabric github repository](https://github.com/hechain20/hechain/blob/main/images/peer/README.md)

# What is a Hechain peer?

Hechain is an enterprise-grade permissioned distributed ledger framework for developing solutions and applications. Its modular and versatile design satisfies a broad range of industry use cases. It offers a unique approach to consensus that enables performance at scale while preserving privacy.
...
Hechain peer, using name peer0.org1.example.com, and exposing the peer's 7051 port
on the host as port 7051.

Read on for a quick primer on the configuration and data volumes. For full details, see
the [Hechain documentation](https://hyperledger-fabric.readthedocs.io/en/latest/).
...
Because Hechain is a permissioned blockchain, the peer needs credentials to join a channel
...
Hechain is licensed under the [Apache License](https://github.com/hechain20/hechain/blob/main/LICENSE).
